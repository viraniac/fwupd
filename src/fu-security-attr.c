...
fu_security_attr_get_name(FwupdSecurityAttr *attr)
{
	...
	if (g_strcmp0(appstream_id, FWUPD_SECURITY_ATTR_ID_PLATFORM_ROLLBACK_PROTECTION) == 0) {
	...
	if (g_strcmp0(appstream_id, FWUPD_SECURITY_ATTR_ID_SPI_WRITE_PROTECTION) == 0) {
