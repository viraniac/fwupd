...
G_DECLARE_FINAL_TYPE(FuGenesysScalerFirmware, fu_genesys_scaler_firmware, FU, GENESYS_SCALER_FIRMWARE, FuFirmware)
...
typedef struct __attribute__((packed)) {
	...
	union {
		...
		struct {
			 ...
			 * HAWK bypass mode
			 *
			 * 0: No support HAWK by pass mode
			 * 1: Support HAWK by pass mode
			 */
